...
export var MyLabel = function (_a) {
    ...
    return (_jsx("span", __assign({ className: "".concat(size, "  color: text-").concat(color, " label"), style: { color: fontColor, backgroundColor: backgroundColor } }, { children: allCaps === true ? label.toUpperCase() : label }), void 0));
};
